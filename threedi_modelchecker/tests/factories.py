...
# TODO add factories for new tables
# TODO use new factories
class InitialConditionsFactory(factory.alchemy.SQLAlchemyModelFactory):
    class Meta:
        model = models.InitialConditions
