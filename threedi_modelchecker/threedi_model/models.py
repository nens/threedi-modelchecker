...
class NumericalSettings(Base):
    ...
    precon_cg = Column(Integer, nullable=False)
    ...
    use_of_cg = Column(IntegerEnum(constants.OffOrStandard), nullable=False)
    use_of_nested_newton = Column(Boolean, nullable=False)
...
class GlobalSetting(Base):
    ...
    epsg_code = Column(Integer, nullable=False)
    ...
    frict_avg = Column(Boolean, nullable=False)
