...
def upgrade():
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),info={"ifexists": True},
    )
    op.create_table(
        "v2_2d_lateral",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["connection_node_id"],
            ["v2_connection_nodes.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("connection_node_id"),info={"ifexists": True},
    )
    op.create_table(
        "v2_1d_lateral",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["v2_cross_section_definition.id"],
        ),
        sa.PrimaryKeyConstraint("id"),info={"ifexists": True},
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["v2_numerical_settings.id"],
        ),
        sa.ForeignKeyConstraint(
            ["simple_infiltration_settings_id"],
            ["v2_simple_infiltration.id"],
        ),
        sa.PrimaryKeyConstraint("id"),info={"ifexists": True},
    )
    op.create_table(
