...
CHECKS += [
    QueryCheck(
        ...
        message="No surface inflow will be generated for this feature, because simulation_template_settings.use_0d_inflow is False.",
    ),
    QueryCheck(
        error_code=616,
        level=CheckLevel.WARNING,
        ...
        message="No dry weather inflow will be generated for this feature, because simulation_template_settings.use_0d_inflow is False.",
    ),
]
