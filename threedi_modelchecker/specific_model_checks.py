...
def get_invalid_bank_levels_errors(session):
    invalid_bank_levels_q = query_invalid_bank_levels(session)
    invalid_bank_level_errors = yield_model_errors(
        model_errors.BaseModelError,
        invalid_bank_levels_q,
        models.CrossSectionLocation.bank_level
    )
    return invalid_bank_level_errors
